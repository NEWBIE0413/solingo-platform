...
const isScript = (t: string) => /[぀-ヿ가-힣一-龯]/.test(t) && t.length <= 8;
...
export const QuestionBubble = ({ question }: QuestionBubbleProps) => {
  ...
  return (
    <div className="mb-6 flex items-center gap-x-4">
      ...
      <div className={`relative rounded-xl border-2 px-4 py-2 ${big ? "kana text-5xl leading-tight text-neutral-700 lg:text-6xl" : "text-lg lg:text-xl"}`}>
        {question}
